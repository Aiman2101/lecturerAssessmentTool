...
th {
 ...
 <body>
  ...
  <li style="float:right"></i><input style="margin-right:20px;background-color:#9E5A63; " type = "submit" name = "reset" value = "Logout"/></li>
         ...
         <h2 style="margin-bottom:20px;">&nbspQuestions for Section 1: Teaching Method, Strategies and Practices</h2>
         ...
         $stmt = $pdo->query("SELECT question_id, questions FROM question WHERE section_id=1");
