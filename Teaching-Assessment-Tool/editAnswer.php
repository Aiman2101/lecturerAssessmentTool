...
th {
 ...
 <body>
  ...
  <li style="float:right"></i><input style="margin-right:20px;background-color:#9E5A63; " type = "submit" name = "reset" value = "Logout"/></li>
         ...
         <h2 style="margin-bottom:20px;font-family:cursive">&nbspAnswers</h2>
         ...
         $stmt = $pdo->query("SELECT DISTINCT answer FROM answer");
         while ( $row = $stmt->fetch(PDO::FETCH_ASSOC) ) {
           echo "<tr>";
           echo "<td>" . $row['answer'] . "</td>";
           echo "<td>" . '<a href="updateAnswer.php?answer='. $row['answer'].'">Edit</a>' . "</td>";
           echo "</tr>";
         }
         ?>
         </table>
